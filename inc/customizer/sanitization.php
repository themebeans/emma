 ...
 */
function emma_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function emma_sanitize_css( $css ) {
 ...
 */
function emma_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function emma_sanitize_email( $email, $setting ) {
 ...
 */
function emma_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function emma_sanitize_html( $html ) {
 ...
 */
function emma_sanitize_image( $image, $setting ) {
 ...
 */
function emma_sanitize_nohtml( $nohtml ) {
 ...
 */
function emma_sanitize_number_absint( $number, $setting ) {
...
function emma_sanitize_number_intval( $int ) {
	return intval( $int );
}
 ...
 *                    the setting default.
 */
function emma_sanitize_number_range( $number, $setting ) {
 ...
 */
function emma_sanitize_select( $input, $setting ) {
 ...
 */
function emma_sanitize_url( $url ) {
